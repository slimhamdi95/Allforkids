...
/* Header style with open responsive navigation */
(function ($) { 
	$('.responsive_nav').on('click', function () { 
		var headerRespBut = $(this), 
			Header = headerRespBut.parents('#page').find('#header');
		
		if (headerRespBut.hasClass('active')) {
			Header.removeClass('resp_nav_open');
		} else {
			Header.addClass('resp_nav_open');
		}
	} );
} )(jQuery);
